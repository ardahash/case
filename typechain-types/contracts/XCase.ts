...
export interface XCaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface XCase extends BaseContract {
  connect(runner?: ContractRunner | null): XCase;
  waitForDeployment(): Promise<this>;

  interface: XCaseInterface;
